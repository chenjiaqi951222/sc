...
public class Test {
    ...
    public void testExecute() {
        jdbcTemplate.execute("create table user1(id integer,name varchar(20))");
    }
    ...
    public void testUpdate2() {
        ...
        jdbcTemplate.update(sql,"女","张飞");
    }

    @org.junit.Test
    public void testBathUpdate() {
        String[] sqls={
                "insert into student(name,sex) values('何洁','女')",
                "insert into student(name,sex) values('陈','男')",
                "update student set sex = '女' where name = '陈'"
        };
    ...
    public void testQueryEntity1() {
        String sql = "select * from student where id = ?";
        Student stu = jdbcTemplate.queryForObject(sql, new StudentRowMapper());
        System.out.println(stu);
    }
